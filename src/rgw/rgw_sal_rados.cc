...
int RadosZone::list_zonegroups(const DoutPrefixProvider *dpp, std::list<std::string>& zonegroups)
{
  /* XXX dang Assume zone has same zonegroups as us */
  return store->svc()->zone->list_zonegroups(dpp, zonegroups);
}
